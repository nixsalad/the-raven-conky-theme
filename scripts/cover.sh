...
cp $HOME/.config/conky/the-raven-conky-theme/res/nocover.png /tmp/conkyCover.png
echo "NoCover" >> $LOG
...
convert /tmp/cover.png $HOME/.config/conky/the-raven-conky-theme/res/case.png -composite /tmp/cover.png >> $LOG
